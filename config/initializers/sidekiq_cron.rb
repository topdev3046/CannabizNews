if Rails.env.production?
	...
	Sidekiq::Cron::Job.create(name: 'Leafly Disp WA 1', cron: '0 1,5,9,13,17,21 * * *', class: 'LeaflyDispensaryWorker1')
	Sidekiq::Cron::Job.create(name: 'Leafly Disp WA 2', cron: '15 1,5,9,13,17,21 * * *', class: 'LeaflyDispensaryWorker2')
	Sidekiq::Cron::Job.create(name: 'Leafly Disp WA 3', cron: '30 1,5,9,13,17,21 * * *', class: 'LeaflyDispensaryWorker3')
	Sidekiq::Cron::Job.create(name: 'Leafly Disp WA 4', cron: '45 1,5,9,13,17,21 * * *', class: 'LeaflyDispensaryWorker4')
	
	Sidekiq::Cron::Job.create(name: 'Leafly Disp CO 5', cron: '0 3,7,11,15,19,23 * * *', class: 'LeaflyDispensaryWorker5')
	Sidekiq::Cron::Job.create(name: 'Leafly Disp CO 6', cron: '15 3,7,11,15,19,23 * * *', class: 'LeaflyDispensaryWorker6')
	Sidekiq::Cron::Job.create(name: 'Leafly Disp CO 7', cron: '30 3,7,11,15,19,23 * * *', class: 'LeaflyDispensaryWorker7')
	Sidekiq::Cron::Job.create(name: 'Leafly Disp CO 8', cron: '45 3,7,11,15,19,23 * * *', class: 'LeaflyDispensaryWorker8')
